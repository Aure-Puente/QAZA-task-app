...
function getDateFromKey(value) {
    ...
    const initialStartDate =
        getObjectiveStartDate(objective) || getWeekStart(new Date());

    const [weekBaseDate, setWeekBaseDate] = useState(initialStartDate);

    const startDate = useMemo(() => getWeekStart(weekBaseDate), [weekBaseDate]);
    const endDate = useMemo(() => getWeekEnd(weekBaseDate), [weekBaseDate]);

    const initialCategory = getNoteCategoryByKey(objective?.categoryKey);
    ...
    const handleSave = async () => {
        if (!objective?.id) {
        Alert.alert("Error", "No se encontró el objetivo semanal.");
        return;
        }
        ...
        Alert.alert("Error", "No se pudo actualizar el objetivo semanal.");
        } finally {
        setSaving(false);
        }
    };
        ...
        <View style={styles.screen}>
            ...
            >
                ...
                <Text variant="bodyMedium" style={styles.subtitle}>
                    Actualizá el título, semana, categoría o responsables del objetivo.
                </Text>
                </View>
                ...
                >
                    ...
                    <Text style={styles.weekControlText}>Semana anterior</Text>
                </Pressable>
                ...
                >
                    <Text style={styles.weekControlText}>Semana siguiente</Text>
                ...
                <Card.Content style={styles.cardContent}>
                    ...
                    <Text style={styles.infoText}>
                        Al guardar, el objetivo mantendrá el mismo estado actual y se actualizará en el calendario.
                    </Text>
                    </View>
