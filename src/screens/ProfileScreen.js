...
export default function ProfileScreen() {
  ...
  const { isDarkMode, themeMode, toggleThemeMode, changeThemeMode } = useAppThemeMode();
  ...
  const currentThemeIcon = isDarkMode ? "moon-waning-crescent" : "white-balance-sunny";

  const themeButtonLabel = isDarkMode ? "Cambiar a tema claro" : "Cambiar a tema oscuro";
  const themeButtonIcon = isDarkMode ? "white-balance-sunny" : "moon-waning-crescent";
